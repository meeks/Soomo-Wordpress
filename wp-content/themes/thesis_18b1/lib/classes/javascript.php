...
class thesis_javascript {
	...
	function output_scripts() {
		...
		global $thesis_site, $thesis_design, $thesis_terms;
		...
		if (is_home() || is_front_page()) {
			...
			$libs = ($page_id) ? get_post_meta($page_id, 'thesis_javascript_libs', true) : $thesis_design->home['javascript']['libs'];
			$page_scripts = ($page_id) ? get_post_meta($page_id, 'thesis_javascript_scripts', true) : $thesis_design->home['javascript']['scripts'];
		}
