...
?>
				...
				<div class="caption">
						<h1><?php if ( is_day() ) : ?>
				<?php printf( __( 'Archives: %s', 'slideo' ), get_the_date() ); ?>
<?php elseif ( is_month() ) : ?>
				<?php printf( __( 'Archives: %s', 'slideo' ), get_the_date('F Y') ); ?>
<?php elseif ( is_year() ) : ?>
				<?php printf( __( 'Archives: %s', 'slideo' ), get_the_date('Y') ); ?>
<?php else : ?>
				<?php _e( 'Blog Archives', 'slideo' ); ?>
<?php endif; ?></h1>
					</div>
